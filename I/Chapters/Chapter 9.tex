...
\begin{proofenv}[of Lemma]
    $\pl\eta\pl\ge \sup_{x\in E,0<\pl x\pl_E< r}\frac{\pl\eta(x)\pl_F}{\pl x\pl_E}$. $\forall y\in E\setminus\{0\}$, $\pl a^N y\pl_{E}=\left|a\right|^N\pl y\pl_E<r$.
...
\begin{definitionenv}
    ...
    $$\pl \varphi\pl \coloneq \sup_{\substack{x_i\in E_i\setminus\{0\}\\i\in\{1,\ldots,n\}}}\frac{\pl \varphi(x_1,\ldots,x_n)\pl_F}{\pl x_1\pl_{E_1}\cdots \pl x_n\pl_{E_n}}.$$
...
\begin{proofenv}
    ...
    \begin{align*}
        \pl f(\varphi)\pl&=\sup_{x_j\in E_j\setminus\{0\},j=1,\ldots,i}\frac{\pl \varphi(x_1,\ldots,x_i,\cdot)\pl}{\pl x_1\pl_{E_1}\cdots \pl x_n\pl_{E_i}}\\
        &=\sup_{x_j\in E_j\setminus\{0\},j=1,\ldots,i}\sup_{x_k\in E_k\setminus\{0\},k=i+1,\ldots,n}\frac{\pl \varphi(x_1,\ldots,x_n)\pl_F}{\pl x_1\pl_{E_1}\cdots \pl x_n\pl_{E_n}}\\
        &=\pl \varphi\pl.
    \end{align*}
...
\begin{definitionenv}
    ...
    \quad Let $n\in \NN_{\ge 2}$, $x_1,\ldots,x_n$ be distinct elements of $X$. We denote by $(x_1\ x_2\cdots x_n)$ the element of $\mathfrak{S}_X$ that sends $x_i$ to $x_{i+1}$, $(i\in \{1,\ldots,n-1\})$, $x_n$ to $x_1$, $y\in X\setminus\{x_1,\ldots,x_n\}$ to $y$ itself. This element is called an $n$-cycle.
...
\end{theoremenv}
\begin{proofenv}
    Suppose that $\Omega$ is not dense. Let $x_0\in X\setminus \overline{\Omega}$, exists $\varepsilon>0$ such that $B(x_0,\varepsilon)\subseteq X\setminus \overline{\Omega}$.
...
\end{corollaryenv}
\begin{proofenv}
    Let $\Omega_n=X\setminus Y_n$. Suppose that $\forall n\in \NN$, $Y_n^\circ=\varnothing$.
    Then $\overline{\Omega}_n=X\setminus Y_n^\circ=X$. Thus $\Omega\coloneq \bigcap_{n\in \NN}\Omega_n$ is dense in $X$. Namely, $X=\Omega$. So
    $$\varnothing=X\setminus \overline{\Omega}=\left(X\setminus \Omega\right)^\circ=\left(X\setminus \bigcap_{n\in \NN}\Omega_n\right)^\circ=\left(\bigcup_{n\in \NN}Y_n\right)^\circ=X^\circ=X.$$
    Contradiction.
\end{proofenv}
