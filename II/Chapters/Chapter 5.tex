...
\begin{proofenv}
    ...
    So in the reasoning without losing of generality,
    ...
    Hence, without losing of generality, we may assume that $c_{n,n}(f) = 1$.
    Replacing $f$ by
...
\end{theoremenv}
\begin{proofenv}
    Without losing of generality, we assume that $E = \RR^n$, $n = \dim(E)$.
