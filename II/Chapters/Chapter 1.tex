...
\end{exampleenv}
\begin{exampleenv}
    Let $K$ be a commutable unitary ring and $I$ be a set. Let $F:\mathbf{Mon}\rightarrow\mathbf{Set}$ be a functor that is representable by the direct sum $K^{\oplus I}$.
    $$ \begin{array}{rrcl}
    ...
    $$ \begin{array}{rcl}
        W^I & \rightarrow & \mathbf{Mod}_{K}\left(K^I, W\right)\\
